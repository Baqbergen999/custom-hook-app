        ...
        <div className="flex-1 min-w-[180px] mr-[40px]">
          ...
          <ul className="list-none p-0">
            <li className="mb-[12px]">
              <a
                href="#"
                className="no-underline text-[#bbbbbb] text-[14px] transition-colors duration-300 hover:text-white"
              >
                About Us
              </a>
            </li>
          ...
          <div className="flex gap-[12px]">
            <a href="#">
              <svg
                ...
                viewBox="0 0 512 512"
                stroke="#ffffff"
                className="w-[34px] h-[34px] bg-[#2e2e2e] p-[8px] rounded-full transition-colors duration-300 hover:bg-[#e91e63]"
              >
