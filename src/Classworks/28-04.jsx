  ...
  return (
    <div>
      <main className="container mx-auto px-40 py-10">
        ...
        <p className="font-10 my-5">
          Познакомьтесь нашими партнёрами-работодателями и совместными
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="bg-gray-200  rounded-lg shadow-md p-10">
            ...
            <p>
              ...
              ad unde maiores voluptatem nostrum porro assumenda ab dolorum
              ullam alias! Natus repellat id dolorem repellendus cupiditate!
            </p>
          ...
          <div className="bg-gray-800  rounded-lg shadow-md p-10">
            <h1 className="text-start mt-10 text-white text-3xl">
              And yet a <br />
              lot of companies
            </h1>
          </div>
