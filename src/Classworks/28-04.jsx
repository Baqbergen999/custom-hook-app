            ...
            <main className="container mx-auto px-40 py-10">
                ...
                <div className="grid grid-cols-3 gap-4">
                    <div className="bg-gray-200  rounded-lg shadow-md p-10">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum tempore itaque beatae vero corporis pariatur similique vel quas commodi, architecto dicta delectus magnam ab, voluptas ut corrupti numquam aspernatur consequuntur.</p>
